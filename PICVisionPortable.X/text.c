...
void put_char(uint8_t c){
	...
	case FONT_SHEX:	
		if (c<16){
			put_sprite(xpos,ypos,SHEX_HEIGHT,&font_hex_4x6[c*SHEX_HEIGHT]);
			xpos+=SHEX_WIDTH;
	...
	case FONT_LHEX:
		if (c<16){
			put_sprite(xpos,ypos,LHEX_HEIGHT,&font_hex_8x10[c*LHEX_HEIGHT]);
			xpos+=LHEX_WIDTH;
	...
	case FONT_ASCII:
		if (c=='\n'){
			...
			put_sprite(xpos,ypos,CHAR_HEIGHT,&font_6x8[(c-32)*CHAR_HEIGHT]);
			xpos+=CHAR_WIDTH;
