...
SOURCEFILES_QUOTED_IF_SPACED=FAT/byteordering.c FAT/fat.c FAT/partition.c FAT/sd_raw.c games/BLINKY/blinky.c games/SOKOBAN/sokoban.c games/LEM/lem.c Hardware/HardwareProfile.c Hardware/LCDout.c main.c chip8.c text.c tone.c display.c keypad.c c8test.c splash.c filesys.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/FAT/byteordering.o ${OBJECTDIR}/FAT/fat.o ${OBJECTDIR}/FAT/partition.o ${OBJECTDIR}/FAT/sd_raw.o ${OBJECTDIR}/games/BLINKY/blinky.o ${OBJECTDIR}/games/SOKOBAN/sokoban.o ${OBJECTDIR}/games/LEM/lem.o ${OBJECTDIR}/Hardware/HardwareProfile.o ${OBJECTDIR}/Hardware/LCDout.o ${OBJECTDIR}/main.o ${OBJECTDIR}/chip8.o ${OBJECTDIR}/text.o ${OBJECTDIR}/tone.o ${OBJECTDIR}/display.o ${OBJECTDIR}/keypad.o ${OBJECTDIR}/c8test.o ${OBJECTDIR}/splash.o ${OBJECTDIR}/filesys.o
...
# Source Files
SOURCEFILES=FAT/byteordering.c FAT/fat.c FAT/partition.c FAT/sd_raw.c games/BLINKY/blinky.c games/SOKOBAN/sokoban.c games/LEM/lem.c Hardware/HardwareProfile.c Hardware/LCDout.c main.c chip8.c text.c tone.c display.c keypad.c c8test.c splash.c filesys.c
...
${OBJECTDIR}/c8test.o: c8test.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/c8test.o.d 
	@${RM} ${OBJECTDIR}/c8test.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  c8test.c  -o ${OBJECTDIR}/c8test.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/c8test.o.d"      -g -D__DEBUG -D__MPLAB_DEBUGGER_PICKIT2=1    -omf=elf -D_CHIPCON_ -D__PIC24__ -O1 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/c8test.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
...
${OBJECTDIR}/c8test.o: c8test.c  nbproject/Makefile-${CND_CONF}.mk
	...
	@${RM} ${OBJECTDIR}/c8test.o.d 
	@${RM} ${OBJECTDIR}/c8test.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  c8test.c  -o ${OBJECTDIR}/c8test.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MMD -MF "${OBJECTDIR}/c8test.o.d"        -g -omf=elf -D_CHIPCON_ -D__PIC24__ -O1 -msmart-io=1 -Wall -msfr-warn=off
	@${FIXDEPS} "${OBJECTDIR}/c8test.o.d" $(SILENT)  -rsi ${MP_CC_DIR}../ 
